...
6º - Trabajaremos con campos calculados, restricciones sobre campos, valores predeterminados, flujos de trabajo...
...
class Opportunity(Workflow, ModelSQL, ModelView):
    ...
    address = fields.Many2One('party.address', "Address", domain=[('party', '=', Eval('party',-1)),])
    ...
    # Definir flujos de trabajo, es decir, podemos permitir que opportunity siga un estado.
    ...
    def __setup__(cls):
      ...
      # EN ESTE METODO DEBEN ANIADIRSE LOS BUTTONS UPDATE

    # FALTAN LOS METODOS PARA CADA BOTON
